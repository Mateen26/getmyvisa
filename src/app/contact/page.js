      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-semibold text-red-900">Talk to a consultant</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-2xl border border-red-100 bg-white p-6 text-sm text-slate-600">
              <p className="font-semibold text-red-900">Office Hours</p>
              <p className="mt-1">{siteConfig.hours}</p>
              <div className="mt-6">
                <p className="font-semibold text-red-900">Our Promise</p>
